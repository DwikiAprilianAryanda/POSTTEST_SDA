...
// Fitur traversal dari belakang
void tampilkanInventoryBelakang(Item* head) {
    ...
    while (tail) {
        cout << "| " << nomor << ". [";
        if (tail->tipe == "Sword") cout << "/|\\";
        else if (tail->tipe == "Potion") cout << "[P]";
        else cout << "*";
        cout << "] " << tail->namaItem << " | Jumlah: " << tail->jumlah << " | Tipe: " << tail->tipe << endl;
        tail = tail->prev;
        nomor--;
    }
    cout << "+--------------------------------------------------+\n";
...
// Fitur detail data berdasarkan NIM
void tampilkanDetailIdentitas(const Identitas& user) {
    cout << "\n+------------------- DETAIL DATA ------------------+\n";
    cout << "| Nama: " << user.nama << endl;
    cout << "| NIM : " << user.nim << endl;
    cout << "+--------------------------------------------------+\n";
}
...
int main() {
    ...
    | 6. Tampilkan Inventory dari Belakang              |
    | 7. Tampilkan Detail Data (NIM)                    |
    | 0. Keluar                                         |
    +===================================================+
        )" << endl;
        cout << "Pilih menu: ";
        ...
        if (pilihan == 1) {
            ...
            tampilkanInventoryBelakang(inventory);
            system("pause");
        } else if (pilihan == 7) {
            tampilkanDetailIdentitas(user);
            system("pause");
        } else if (pilihan == 0) {
